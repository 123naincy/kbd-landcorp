  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        <Navbar />
        {/* Hero Section  */}
        <section className="relative h-screen flex items-center mt-20" id="contact" >
          {/* Background Image */}
          <div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <a
                  href="tel:91-8383060833"  // <-- replace with your URL
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-white opacity-75 mt-6">
                Call now: <a href="tel:91-8383060833" className="text-[#FCAF2E] font-bold">91-8383060833</a>
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <div className="font-bold text-[#2A3674]">Karan singh kaur</div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <div className="font-bold text-[#2A3674]">Harpreet singh</div>
