        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/kbdlandcorp"
                target="_blank"
              ...
              <a
                href="https://twitter.com/kbdlandcorp"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#D2B563] transition-all duration-300 group"
              >
              ...
              <a
                href="https://www.instagram.com/kbdlandcorp_?igsh=ZWFyenE1bWVlNGN3"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#D2B563] transition-all duration-300 group"
              >
              ...
              <a
                href="https://www.linkedin.com/in/kbdlandcorp"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#D2B563] transition-all duration-300 group"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => scrollToSection('home')} className="text-gray-300 hover:text-[#D2B563] transition-colors">
                  Home
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('properties')} className="text-gray-300 hover:text-[#D2B563] transition-colors">
                  Properties
                </button>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => scrollToSection('agents')} className="text-gray-300 hover:text-[#D2B563] transition-colors">
                  Our Experts
                </button>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                Chandigarh-Manali Highway,<br></br>
                Mohali, Punjab, 140301
              </li>
              <li>
                <a href="tel:+91 8448220334" className="hover:text-[#D2B563] transition-colors">
                  +91 8448220334
                </a>
              </li>
              <li>
