      ...
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <span className="text-rose-400 text-sm font-semibold">{image.category}</span>
                  <h3 className="text-white text-2xl font-bold mt-1">{image.title}</h3>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-16 bg-gradient-to-r from-rose-50 to-pink-50 rounded-3xl p-12 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            See the property in person and discover why Bridal Square is the perfect
            location for your business.
          </p>
          <a
            href="#contact"
            className="inline-block px-8 py-4 bg-rose-500 hover:bg-rose-600 text-white rounded-full font-semibold transition-all transform hover:scale-105"
          >
            Book Your Visit
          </a>
        </div>
